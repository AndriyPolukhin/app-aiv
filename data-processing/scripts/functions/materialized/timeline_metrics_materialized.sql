...
-- Populate timeline metrics
SELECT refresh_timeline_metrics();

COMMIT;

CREATE INDEX idx_timeline_metrics_time_period ON timeline_metrics_materialized(time_period);
CREATE INDEX idx_timeline_metrics_last_calculated ON timeline_metrics_materialized(last_calculated);